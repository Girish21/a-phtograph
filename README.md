A simple app that fetches images from 500px.com as a gallery and allows users to download the images in HD+ quality and can be set as the background wallpaper of their device from the app.
